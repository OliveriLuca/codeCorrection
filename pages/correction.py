...
def correggi_codice(codice_studente, criteri, testo_esame, modello_scelto, client):
     ...
     **REGOLA CRITICA SULLA DUPLICAZIONE DEGLI ERRORI:** Se identifichi lo stesso identico errore (basato sullo stesso criterio di valutazione)
     più volte all'interno della STESSA funzione, devi segnalarlo e detrarre i punti **SOLO UNA VOLTA**. Scegli la prima occorrenza dell'errore in quella funzione. 
